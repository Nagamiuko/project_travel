...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $tel = $_POST['tel'];
    $permission = isset($_POST['permission']) ?$_POST['permission'] : 'User';
    ...
    $sql = "UPDATE user_travel SET fullname = :name, username = :username, password = :password, address = :address, sex = :sex, tel = :tel, admin_check = :permission";
    if ($avatarFileName) {
